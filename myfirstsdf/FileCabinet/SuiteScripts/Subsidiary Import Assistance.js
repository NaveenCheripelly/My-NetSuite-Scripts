        ...
        function onRequest(context) {
            ...
            try {
                if (context.request.method === 'GET') {
                    ...
                    JSONobj = JSONobj + '"ATTENTION":"attention","ADDRESSEE":"addressee","PHONE":"addrphone","ADDRESS 1":"addr1","ADDRESS 2":"addr2","CITY":"city","STATE":"substate","COUNTRY":"subcountry","ZIP":"zip","IS SHIP ADDR SAME AS SUB ADDR?":"shippingaddress_text","IS RETURN ADDR SAME AS SUB ADDR?":"returnaddress_text"'; 
                    JSONobj = JSONobj + '}';
                    ...
                    finalTemplate = finalTemplate + ',ATTENTION,ADDRESSEE,PHONE,ADDRESS 1,ADDRESS 2,CITY,STATE,COUNTRY,ZIP,IS SHIP ADDR SAME AS SUB ADDR?,IS RETURN ADDR SAME AS SUB ADDR?';
 ...
 */
                    ...
                    if (flag != 1) {
                        ...
                        instructstring += '<p>&nbsp;</p>';
                        instructstring += '<p style="font-size:130%;margin-left: 4px;">1. Download the sample CSV template by clicking on the "Download Template to Create/Update Subsidiary"</p><br/>';
                        ...
                        instructstring += '<p style="font-size:130%;margin-left: 4px;">3. Tool automatically indentifies whether to create/update subsidiary based on "Internal Id" & "Company Code".</p><br/>';
                        instructstring += '<p style="font-size:130%;margin-left: 4px;">4. Ensure to give "true" or "false" for the checkbox fields and questions mentioned in the file.</p><br/>';
                        instructstring += '<p style="font-size:130%;margin-left: 4px;">5. Ensure to give the parent-child relationship properly.</p><br/>';
                        instructstring += '<p style="font-size:130%;margin-left: 4px;">6. Remove the columns which are not needed to create/update from the file.</p><br/>';
                        instructstring += '<p style="font-size:130%;margin-left: 4px;">6. If the cell in csv is given empty, we consider to update the field value as empty.Please remove the column instead.</p><br/>';
                        instructstring += '<p style="font-size:130%;margin-left: 4px;">7. Please use the CSV file with proper data and click on "Upload Subsidiary" Button to upload the CSV file into NetSuite.</p><br/>';
                        instructstring += '</div>';
                        instructstring += '<p>&nbsp;</p>';
                        instructstring += '<p>&nbsp;</p>';
                        instructstring += '</div>';
